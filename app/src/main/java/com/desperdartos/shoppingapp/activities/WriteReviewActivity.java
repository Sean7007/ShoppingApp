...
import com.desperdartos.shoppingapp.commands.WriteReviewActivityClicks;
import com.desperdartos.shoppingapp.databinding.ActivityWriteReviewBinding;
    ...
    private void loadShopInfo() {
        ...
        reference.child(shopUid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    Picasso.get().load(shopImage).placeholder(R.drawable.ic_store_24).into(binding.profileIv);
                } catch (Exception e) {
