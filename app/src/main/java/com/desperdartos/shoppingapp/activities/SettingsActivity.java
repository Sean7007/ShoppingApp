...
import com.desperdartos.shoppingapp.commands.SettingsActivityClicks;
import com.desperdartos.shoppingapp.databinding.ActivitySettingsBinding;
    ...
    private void subscribeToTopic() {
        FirebaseMessaging.getInstance().subscribeToTopic(Constants.FCM_TOPIC).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                //save settings in sharedPreference
                spEditor = sp.edit();
