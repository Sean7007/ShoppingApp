...
import com.desperdartos.shoppingapp.adapters.AdapterOrderedItem;
import com.desperdartos.shoppingapp.commands.OrderDetailsUsersActivityClicks;
import com.desperdartos.shoppingapp.databinding.ActivityOrderDetailsUsersBinding;
...
public class OrderDetailsUsersActivity extends AppCompatActivity {
    ...
    private void loadOrderItems() {
        ...
        reference.child(orderTo).child("Orders")
        ...
        reference.child(orderTo).child("Orders").child(orderId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (orderStatus.equals("In Progress")) {
                    binding.orderStatusTv.setTextColor(getResources().getColor(R.color.teal_200));
                ...
                binding.amountTv.setText("" + orderCost + "[Including Delivery Fee P]" + deliveryFee);
